...
module.exports = "\n<div class=\"fundo\">\n\n    <div class=\"row\">\n        <h4 class=\"center-align\">Clique em uma das nossas artes prontas para visualizar na caneca.</h4>\n        </div>\n\n  <div class=\"row\">\n\n     \n          \n\n          <div class=\"col-sm-12 col-md-2\">\n\n              \n\n\n                <span class=\"list-group\" id=\"list-tab\" role=\"tablist\">\n                    <!-- <span *ngIf=\"isFirst\">\n                        <a class=\"list-group-item list-group-item-action active\" id=\"list-{{ artecaneca.slug }}-list\" data-toggle=\"list\" href=\"#list-{{ artecaneca.slug }}\" role=\"tab\" aria-controls=\"home\">{{ artecaneca.name }}</a>\n                    </span> -->\n                    <a *ngFor=\"let categoria of categoriasarte\"  (click)=teste(categoria.id)  class=\"list-group-item list-group-item-action\" id=\"{{ categoria.slug }}-list\" data-toggle=\"list\" href=\"#{{ categoria.slug }}\" role=\"tab\">{{ categoria.name }}</a>\n              \n                    <!-- {{ artescanecas.length }} -->\n\n                    \n                </span>\n\n               \n              \n          </div>\n          <div class=\"col-sm-12 col-md-5\">\n            <div class=\"tab-content\" id=\"nav-tabContent\">\n              <!-- <div class=\"tab-pane fade show active\" id=\"list-home\" role=\"tabpanel\" aria-labelledby=\"list-home-list\">\n                  <span *ngFor=\"let artecaneca of artescanecas\">\n                      <img width=\"200px\" src=\"{{ artecaneca.image_thumb }}\" (click)=\"local = artecaneca.image\"/>\n                  </span>\n                \n              </div> -->\n              \n                  <img *ngFor=\"let artecaneca of artescanecasNova\" width=\"200px\" src=\"{{ artecaneca.image_thumb }}\" (click)=\"local = artecaneca.image\"/>\n\n                \n              \n              \n\n            </div>\n          </div>\n\n          <div class=\"col-sm-12 col-md-5\">\n              <section class=\"container\">\n                <div id=\"carousel\">\n                \n                    <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">1</figure> \n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">2</figure> \n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">3</figure> <!-- 16 nth-child(2)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">4</figure> <!-- 1  nth-child(3)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">5</figure>\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local_aba+')' }\"></figure> <!-- 3 nth-child(5)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">7</figure>\n                  <figure></figure> <!-- 3 nth-child(5)-->\n                  \n                   <!-- 6 nth-child(14)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local_aba+')' }\"></figure> <!-- aba nth-child(7) -->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">10</figure> <!-- 6 nth-child(14)-->\n                \n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">11</figure> <!-- 7 nth-child(15)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">12</figure> <!-- 8 nth-child(16) -->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">13</figure> <!-- 9 nth-child(17)-->\n\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">14</figure> <!-- 13 nth-child(11)-->\n                  \n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">15</figure> <!-- 11 nth-child(19)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">16</figure> <!-- 12 nth-child(20)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">17</figure> <!-- 14 nth-child(22)-->\n                  <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\">18</figure> <!-- 15 nth-child(23)-->\n\n   \n\n\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 7 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 8 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 9 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local_aba+')' }\"></figure> aba -->\n                  <!-- <figure>1</figure> 1 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 2 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 3 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 4 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 5 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local+')' }\"></figure> 6 -->\n                  <!-- <figure [ngStyle]=\"{ 'background-image': 'url('+local_aba+')' }\"> </figure> aba -->\n                </div>\n              </section>\n            </div>\n\n\n    \n  </div>\n  </div>"
